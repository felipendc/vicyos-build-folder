...
buildFolder="$HOME/Vicyos-build-xfce-dark-edition"
...
sed -i "s/iso_name=/iso_name=vicyoslinux-dark/g" work/archiso/profiledef.sh
sed -i "s/iso_label=/iso_label="vicyoslinux-dark-$(date +%Y.%m.%d)"/g" work/archiso/profiledef.sh
sed -i "s/iso_publisher="'""'"/iso_publisher="'"vicyoslinux-dark <https:\/\/github.com\/felipendc>"'"/g" work/archiso/profiledef.sh
sed -i "s/iso_application="'""'"/iso_application="'"vicyoslinux-dark Live\/Rescue CD"'"/g" work/archiso/profiledef.sh
sed -i "s/iso_version=/iso_version="$(date +%Y.%m.%d)"/g" work/archiso/profiledef.sh

# Add the build date to the "DISTRIB_RELEASE"
release=$(date +%Y.%m.%d)
sed -i "s/DISTRIB_ID=VicyosLinux/DISTRIB_ID=VicyosLinux-Dark/g" work/archiso/airootfs/etc/vicyos-release
...
sed -i "s/ISO_CODENAME=VicyosLinux/ISO_CODENAME=VicyosLinux-Dark/g" work/archiso/airootfs/etc/dev-rel
