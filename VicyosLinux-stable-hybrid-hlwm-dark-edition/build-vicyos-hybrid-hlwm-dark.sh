...
buildFolder="$HOME/Vicyos-build-hybrid-hlwm-dark"
...
sed -i "s/iso_name=/iso_name=vicyos-hybrid-hlwm/g" work/archiso/profiledef.sh
sed -i "s/iso_label=/iso_label="vicyos-hybrid-hlwm-$(date +%Y.%m.%d)"/g" work/archiso/profiledef.sh
sed -i "s/iso_publisher="'""'"/iso_publisher="'"vicyos-hybrid-hlwm <https:\/\/github.com\/felipendc>"'"/g" work/archiso/profiledef.sh
sed -i "s/iso_application="'""'"/iso_application="'"vicyos-hybrid-hlwm Live\/Rescue CD"'"/g" work/archiso/profiledef.sh
sed -i "s/iso_version=/iso_version="$(date +%Y.%m.%d)"/g" work/archiso/profiledef.sh

# Add the build date to the "DISTRIB_RELEASE"
release=$(date +%Y.%m.%d)
sed -i "s/DISTRIB_ID=VicyosLinux/DISTRIB_ID=VicyosLinux-hybrid-hlwm/g" work/archiso/airootfs/etc/vicyos-release
...
sed -i "s/ISO_CODENAME=VicyosLinux/ISO_CODENAME=VicyosLinux-hybrid-hlwm/g" work/archiso/airootfs/etc/dev-rel
...
echo
echo "################################################################## "
tput setaf 2;echo "Phase 6 : Build ISO";tput sgr0
echo "################################################################## "
echo
